...
try:
    from mflowy.builtin_plugins.model.predict import predict
...
def mock_loader(monkeypatch):
    ...
    def _patch(estimators, wrapper_cls):
        ...
        monkeypatch.setattr(
            "mflowy.builtin_plugins.model.loader.loader",
            _fake_loader,
        )
        return model_loader
...
def mock_mlflow(monkeypatch):
    monkeypatch.setattr("mflowy.builtin_plugins.model.predict.mlflow.set_tag", lambda k, v: None)
