...
try:
    from mflowy.builtin_plugins.model._catboost import CatBoostClassifier, CatBoostRegressor
    from mflowy.builtin_plugins.model._lightgbm import LGBMClassifier, LGBMRegressor
    from mflowy.builtin_plugins.model._names import NamesMixin
    from mflowy.builtin_plugins.model._neural_network import LitNeuralNetwork
    from mflowy.builtin_plugins.model._random_forest import RandomForestClassifier, RandomForestRegressor
    from mflowy.builtin_plugins.model._xgboost import XGBClassifier, XGBRegressor
