...
# Vendored from Yannick Copin's taylorDiagram.py (public domain / CC BY 4.0):
#   https://gist.github.com/ycopin/3342888
#   https://zenodo.org/records/5548061
# mflowy 注：仅作原样 vendor（无修改）；若日后修改请在此登记。
# 替换 GPLv3 的 skillmetrics 绘制。
    ...
    def __init__(self, refstd, fig=None, rect=111, label="_", srange=(0, 1.5), extend=False):
        ...
        * extend: extend diagram to negative correlations
        ...
        ghelper = FA.GridHelperCurveLinear(
            tr, extremes=(0, self.tmax, self.smin, self.smax), grid_locator1=gl1, tick_formatter1=tf1
        )
