...
class TestDiscoverTable:
    def test_name_is_identity(self, fake_entry_points):
        fake_entry_points.append(_ep("load.csv", "mflowy.compute.loaders.csv_loader:csv"))
        table = discover()
        assert table["load"]["csv"].value == "mflowy.compute.loaders.csv_loader:csv"
...
class TestLoadContract:
    ...
    def test_get_post_init_returns_converter(self, fake_entry_points):
        fake_entry_points.append(_ep("X_y.x_y", "mflowy.compute.x_y:x_y"))
