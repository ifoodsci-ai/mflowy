...
from mflowy.compute.cross_validation.types import DatasetLoader, X_idx, y_idx
from mflowy.compute.plots.base import DPI
from mflowy.middlewares.log_plot import log_figure
...
def _plot_regression(df: pd.DataFrame) -> None:
    from mflowy.compute.plots.model_evaluation.regression.error_distribution import error_distribution
    from mflowy.compute.plots.model_evaluation.regression.prediction_scatter import prediction_scatter
    from mflowy.compute.plots.model_evaluation.regression.residual_scatter import residual_scatter
...
def _plot_classification(df: pd.DataFrame) -> None:
    from mflowy.compute.plots.model_evaluation.classification.confusion_matrix import confusion_matrix
